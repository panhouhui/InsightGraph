...
import { chatModeReadableLables, mergeNestedObjects, orderedLlms } from '../../utils/Constants';
    ...
    <div className='n-bg-palette-neutral-bg-weak p-4'>
      ...
      <Flex className='p-4'>
        ...
        <Tabs.TabPanel tabId={8} value={activeTab}>
          <Stack spacing={2}>
            <Stack spacing={2}>
              {!orderedLlms.includes(metricmodel) && (
                <Banner
                  type='warning'
                  ...
                  description={
                    <Typography variant='body-medium'>
                      ...
                      {orderedLlms.map((s, idx) => (
                        <span className='font-bold' key={s}>
                          {capitalizeWithUnderscore(s) + (idx != orderedLlms.length - 1 ? ',' : '')}
                        </span>
                      ))}
                      .
                    </Typography>
            ...
            {isSingleMode &&
              (isAdditionalMetricsWithSingleMode === false || isAdditionalMetricsWithSingleMode === null) && (
                <Button
                  isDisabled={metricsLoading || !orderedLlms.includes(metricmodel)}
